...
const IportalJobApply = lazy(()=>import('./Components/iportal/jobs/job_application'));
        ...
        <BrowserRouter>
          <div className="App">
            <Switch>
              ...
              <Route path='/iportal/jobs/:startup_id/:startup_name/:job_title/:job_id/apply' component={IportalJobApply} />
              <Route path='/iportal/jobs/:startup_id/opening/:job_title/:job_id' component={IportalJobDetail} />
