# Generated by Django 2.2.1 on 2019-06-02 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fb_score', models.IntegerField(default=0)),
                ('tw_score', models.IntegerField(default=0)),
                ('li_score', models.IntegerField(default=0)),
                ('wp_score', models.IntegerField(default=0)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='CampuCampusAmbassadurProfile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
